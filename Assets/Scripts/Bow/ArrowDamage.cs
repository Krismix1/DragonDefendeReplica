...
public class ArrowDamage : MonoBehaviour {
    ...
    private void DoCriticalDamage(GameObject enemy, int damage, float criticalMultiplier) {
        int criticalDamage = Mathf.RoundToInt(arrowDamage * criticalDamageMultiplier);
    ...
    private void DoDamage(GameObject enemy, int amount) {
        enemy.GetComponent<EnemyHealth>().TakeDamage(arrowDamage);
    }
}
